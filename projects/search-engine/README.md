...
Autonomous search relevance optimization — agents evolve scoring scripts to maximize NDCG@10 on the Humans AI search subsystem.

## Baseline

- **Index**: Humans AI search index (local content)
